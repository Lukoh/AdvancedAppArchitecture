...
inline fun <reified T : Any> Fragment.setBackStackData(
    key: String,
    data: T,
    doBack: Boolean = true
) {
...
inline fun <reified T : Any> Fragment.getBackStackData(
    key: String,
    ...
    fragmentManager.addOnBackStackChangedListener {
        ...
        selectedNavController.value?.let { controller ->
            if (controller.currentDestination == null) {
                controller.safeNavigate(controller.graph.id, controller.graph.id)
            }
        }
    }
