package com.goforer.advancedapparchitecture.di.module
...
import com.goforer.advancedapparchitecture.data.source.network.NetworkError
import com.goforer.advancedapparchitecture.data.source.network.NetworkErrorHandler
import com.goforer.advancedapparchitecture.data.source.network.adapter.factory.FlowCallAdapterFactory
import com.goforer.advancedapparchitecture.data.source.network.adapter.factory.NullOnEmptyConverterFactory
import com.goforer.advancedapparchitecture.data.source.network.api.RestAPI
import com.goforer.advancedapparchitecture.presentation.Caller.preparingService
import com.goforer.advancedapparchitecture.presentation.Caller.runNotAvailableNetwork
...
class AppModule {
    ...
    ): Storage = Storage(context, cookieJar)
